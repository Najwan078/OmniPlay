"""
OmniPlay Cloud Computing Ecosystem - Vercel Serverless FastAPI Backend
Handles Steam Integration, Dynamic Rental Pricing, Cloud Node Orchestration, and Authentication
"""
...
# Enable CORS for local dev and Vercel domains
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
